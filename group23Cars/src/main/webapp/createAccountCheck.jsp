	...
	<body>
		<% try {
			...
			if(!result.first())
			{
				...
				String str2 = "INSERT INTO buyer VALUES (" + newIdNum + ", " + newIdNum + ", \'" + entity + "\', \'" + entity2 + "\')";
				int rows = stmt2.executeUpdate(str2);
				
				Statement stmt3 = con.createStatement();
				String str3 = "INSERT INTO seller VALUES (" + newIdNum + ", " + newIdNum + ", \'" + entity + "\', \'" + entity2 + "\')";
				int rows2 = stmt3.executeUpdate(str3);
